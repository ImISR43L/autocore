...
import { Save, Layout, ListChecks, Clock, Code2 } from "lucide-react";
          ...
          <div className="flex-1 overflow-y-auto p-4 md:p-8 scrollbar-thin scrollbar-thumb-zinc-700 scrollbar-track-transparent">
            <div className="max-w-7xl mx-auto min-h-full pb-10">
              ...
              >
                ...
                {/* HTML de Referência (múltiplas páginas) */}
                <div className="bg-surface border border-border rounded-xl p-4 md:p-6 shadow-lg space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-muted mt-1">
                      Cole o HTML de exemplo que represente a solução esperada —
                      adicione quantas páginas precisar (ex: um portfólio com
                      index/sobre/projetos). Não é usado na correção automática,
                      serve só como visualização pra você.
                    </p>
                  </div>

                  <HtmlReferenceFilesEditor />
                </div>
              </div>
